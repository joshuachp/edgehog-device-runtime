...
use tokio::io::{AsyncBufReadExt, AsyncRead, AsyncReadExt, AsyncSeek, AsyncWrite, BufReader};
use tracing::instrument;

use super::request::FileDigest;

/// Wrapper to a [`AsyncRead`] or [`AsyncWrite`] that calculates the written digest.
#[pin_project]
